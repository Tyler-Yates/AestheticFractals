...
public class Fractal implements Serializable {
    ...
    //The image representing the visualization of the fractal. This variable is transient to keep it from being Serialized when the program state is saved.
     ...
     *
     * Each of the parents is represented by an expression tree. Take the two corresponding
     * expression trees for the parents and pick a random node in each tree. The subtrees rooted at these nodes in each
     * expression tree are swapped, yielding a single new Fractal.
     *
     * For example:
     * Parent 1:      Parent 2:
     *     a             d
     ...
     * constant, there is a fixed chance that this constant is altered by a set amount.
     *
     * @return
     */
    ...
    /**
     * Draws the image of the current Fractal at the given coordinate (x,y). The coordinate represents
